...
import { Type, Trash2, ChevronDown } from "lucide-react";
    ...
    <Popover>
      ...
      <PopoverContent className="w-72 space-y-4" align="start">
        ...
        <Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen}>
          <CollapsibleTrigger className="flex items-center gap-1.5 text-xs font-medium text-muted-foreground hover:text-foreground transition-colors cursor-pointer w-full">
